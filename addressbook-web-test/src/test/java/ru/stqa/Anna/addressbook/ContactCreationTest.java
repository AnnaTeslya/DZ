...
public class ContactCreationTest {
    ...
    public void testContactCreation() {
        ...
        gotoContactsPage();
        fillContactPage(new ContactDate("Dasha", "Petrova", "Moscow, Russia", "89678883322", "dashapetrova@mail.ru"));
        submitContactCreation();
        returnContactsPage();
    }

    private void returnContactsPage() {
    ...
    private void fillContactPage(ContactDate contactDate) {
